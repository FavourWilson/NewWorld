<div class="mb-5">
    <div class="bg-img-hero" style="background-image: url({{asset('assets/img/1920X422/img1.jpg')}});">
        <div class="container min-height-420 overflow-hidden">
            @foreach ($ca as $item)
            <div class="js-slick-carousel u-slick" data-animation-delay="0"
                    ...
                    <div class="row min-height-420 py-7 py-md-0">
                        <div class="offset-xl-3 col-xl-4 col-6 mt-md-8">
                            <h1 class="font-size-64 text-lh-57 font-weight-light"
                                ...
                                {{$item->adsname}}
                                    <span class="d-block font-size-55"></span>
                            </h1>
                            <h6 class="font-size-15 font-weight-bold mb-3"
                                data-scs-animation-in="fadeInUp"
                                data-scs-animation-delay="200">{{$item->productname}}
                            </h6>
                            <div class="mb-4"
                                data-scs-animation-in="fadeInUp"
                            ...
                            <a href="{{url('NewWorld/slide/'.$item->id)}}" class="btn btn-primary transition-3d-hover rounded-lg font-weight-normal py-2 px-md-7 px-3 font-size-16"
                                data-scs-animation-in="fadeInUp"
