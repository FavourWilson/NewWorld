      ...
      t.forEach(function (i) {
        i.addEventListener('click', function (t) {
          if (!i.parentElement.classList.contains('nav-item')) {
            ...
            var e = i.parentElement.parentElement.parentElement.querySelector(
              '.nav-link',
            )
            ;(e.ariaExpanded = !0),
  ...
  (function (a) {
    ...
    function t() {
      ;(this.body = a('body')),
        ...
        (this.config = {}),
        (this.defaultBSStyle = a('#bs-default-stylesheet')),
        (this.defaultAppStyle = a('#app-default-stylesheet')),
        (this.darkBSStyle = a('#bs-dark-stylesheet')),
    ...
    ;(t.prototype._saveConfig = function (t) {
        ...
        switch (t) {
          case 'boxed':
            this.body.attr('data-layout-width', 'boxed'),
              a.LeftSidebar.changeSize('condensed'),
              window.dispatchEvent(new Event('adminto.setBoxed')),
      ...
      (t.prototype.init = function () {
        ;(this.leftSidebar = a.LeftSidebar),
          (this.topbar = a.Topbar),
    ...
    ;(t.prototype.initTooltipPlugin = function () {
      ...
      (t.prototype.initCounterUp = function () {
        ...
        o('[data-plugin="counterup"]').each(function (t, e) {
          o(this).counterUp({ delay: i, time: n })
        })
      }),
      (t.prototype.initPeityCharts = function () {
        o('[data-plugin="peity-pie"]').each(function (t, e) {
          ...
          o(this).peity('pie', { fill: i, width: n, height: a })
        }),
          o('[data-plugin="peity-donut"]').each(function (t, e) {
            var i = o(this).attr('data-colors')
              ...
              n = o(this).attr('data-width') ? o(this).attr('data-width') : 20,
              a = o(this).attr('data-height') ? o(this).attr('data-height') : 20
            o(this).peity('donut', { fill: i, width: n, height: a })
          }),
          ...
          o('[data-plugin="peity-bar"]').each(function (t, e) {
            var i = o(this).attr('data-colors')
              ...
              n = o(this).attr('data-width') ? o(this).attr('data-width') : 20,
              a = o(this).attr('data-height') ? o(this).attr('data-height') : 20
            o(this).peity('bar', { fill: i, width: n, height: a })
          })
      }),
    ...
    ;(t.prototype.initControls = function () {
      function t() {
        document.webkitIsFullScreen ||
          ...
          i('body').removeClass('fullscreen-enable')
      }
      setTimeout(function () {
      ...
      (t.prototype.init = function () {
        ...
        window.sessionStorage &&
          ...
          (sessionStorage.getItem('_ADMINTO_VISITED_') ||
            (i.RightBar.toggleRightSideBar(),
            sessionStorage.setItem('_ADMINTO_VISITED_', !0)))
        ;[].slice
